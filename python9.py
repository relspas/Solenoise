...
######################################################################
# To Use:                                                            #
# python9.py [csv file] [tracks to convert (-1 converts all tracks)] #
#                                                                    #
# example:                                                           #
# python9.py furelise.txt 2 3 4                                      #
# example:                                                           #
# python9.py furelise.txt -1                                         #
######################################################################

############################################################################
# Updates: Previously, multiple tracks would overwrite each other and only #
# the last one in the command arguments would pring out. This version      #
# allows mutiple tracks to be printed in the same h file.                  #
# Now checks for more than 7 notes played at once. Processing will stop.   #
# Changes Made 7/28/16                                                     #
############################################################################
...
for timestamp in range (0, duration/sampling_rate + 1):
    ...
    if countNotes(note_list[0:60]) > 7:
